...
import Spinners from '../Components/Sipnners'



const Jobpage_sing = ({deleteJob}) => {
    const {id}=useParams()
    ...
    useEffect(()=>{
        ...
        fetchJob();
    },[]) this is how we can use useEffect for calling API*/ 
  return (
    <>
         <section>
      <div className="container m-auto py-6 px-6">
        ...
        >
          <FaArrowLeft className='mg-2'/>Back to Job Listings
        </Link>
      </div>
    </section>
...
export {Jobpage_sing as default,jobLoader}
